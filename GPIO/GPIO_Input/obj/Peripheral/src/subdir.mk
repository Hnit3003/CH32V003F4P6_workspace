...
Peripheral/src/%.o: ../Peripheral/src/%.c
	@	@	riscv-none-embed-gcc -march=rv32ecxw -mabi=ilp32e -msmall-data-limit=0 -msave-restore -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -fno-common -Wunused -Wuninitialized  -g -I"D:\CH32V003F4P6_Workspace\GPIO\GPIO_Input\Debug" -I"D:\CH32V003F4P6_Workspace\GPIO\GPIO_Input\Core" -I"D:\CH32V003F4P6_Workspace\GPIO\GPIO_Input\User" -I"D:\CH32V003F4P6_Workspace\GPIO\GPIO_Input\Peripheral\inc" -std=gnu99 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
	@	@
